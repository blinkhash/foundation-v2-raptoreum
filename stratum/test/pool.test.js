...
describe('Test pool functionality', () => {
  ...
  test('Test pool workers handling [9]', () => {
    ...
    const expected = { 'RHP3VKiSYH4putQeSKLwr47QDdERa6H6G1': { 'immature': 0, 'generate': -10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [12]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'RHP3VKiSYH4putQeSKLwr47QDdERa6H6G1': { 'immature': 9570.00569668, 'generate': 0 },
      'RHP3VKiSYH4putQeSKLwr47QDdERa6H6G2': { 'immature': 429.99430332, 'generate': 0 }};
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'RHP3VKiSYH4putQeSKLwr47QDdERa6H6G1': { 'immature': -10000, 'generate': 10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], true, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
